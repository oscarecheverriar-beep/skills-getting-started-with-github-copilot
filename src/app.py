...
activities = {
    ...
    "Track and Field": {
        "description": "Running, jumping, and throwing track events",
        "schedule": "Tuesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["james@mergington.edu", "lucy@mergington.edu"]
    },
    "Art Club": {
        "description": "Studio art, painting, drawing, and creative expression",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["sarah@mergington.edu"]
    },
    "Music Ensemble": {
        "description": "Play instruments and perform in musical ensembles",
    ...
    "Science Club": {
        ...
        "max_participants": 22,
        "participants": ["nina@mergington.edu", "tom@mergington.edu"]
    }
}
